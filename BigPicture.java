...
/**
 * Created by hadas on 10/09/2017.
 */
...
public class BigPicture extends AppCompatActivity implements TextToSpeech.OnInitListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    /*public void setImagePaint(int i){
        try {
            switch (i){
                case 2130837616:
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        /*Only after 200 frame, the picture send to color diagnose*/
        onCameraFrameIttr++;
        mRgba = inputFrame.rgba();
        if(onCameraFrameIttr %200==0) {
            takePicture();
        }
        return mRgba;
    }
